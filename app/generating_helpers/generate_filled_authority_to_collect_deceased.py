def generate_filled_authority_to_collect_deceased(deceased_info, executor_info, funeral_director_info, authority_to_collect_info, PdfReader, PdfWriter):
    ...
    from app.paths import document_path, output_file
    reader = PdfReader(document_path("Authority-to-collect-deceased.pdf"))
    writer = PdfWriter()
    ...
    writer.write(output_file(f"authority-to-collect-deceased-{executor_info.name_of_deceased}.pdf"))